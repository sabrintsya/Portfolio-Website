...
const CaseStudy = () => {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      setShowScrollDown(scrollY + windowH < docH - 80);
    };
      ...
      content: (
        <div className={styles.caseStudyContent}>
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-problem.jpg")} alt="UX Research insights showing poverty statistics and challenges" className={styles.contentImage} />
              <p className={styles.caption}>
                <a href="https://www.figma.com/board/OyQCJOrYgPYRpjOyiHNi2N/UX-Research--FS1--Team-Cut-Nyak-Dien--Perempuan-dan-Kemiskinan-?node-id=0-1&t=6yhGNt4dsih9mhRk-1" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See detail here → UX Research</a>
              </p>
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-team.jpg")} alt="The BeautyPreneur team during a virtual project coordination meeting" className={styles.contentImage} />
          ...
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-pivot.jpg")} alt="UX Research showing the pivot from crowdfunding to training platform" className={styles.contentImage} />
            </div>
          ...
          <section className={styles.section}>
            <h2>4. Why Other Ideas Didn't Work</h2>
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-alternatives.jpg")} alt="UX Research showing why alternative ideas were rejected" className={styles.contentImage} />
            </div>
            <ul>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-solution.jpg")} alt="UX Research showing the MVP features and user validation" className={styles.contentImage} />
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-results.jpg")} alt="Documentation of 3rd place achievement at Demo Day" className={styles.contentImage} />
          ...
          <section className={styles.section}>
            <h2>7. Limitations & Future Plans</h2>
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/beauty-wireframe.jpg")} alt="Wireframe showing future improvements and features" className={styles.contentImage} />
              <p className={styles.caption}>
                <a href="https://www.figma.com/design/3SeByBQJphBao3gjcTNl2j/FS1-Cut-nyak-dien---Mockup-UI-Design---Prototype?node-id=2911-623&t=FT8AVikiljVDipuy-1" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See detail → Wireframe</a>
              </p>
            </div>
          ...
          <section className={styles.conclusion}>
            <h2>💬 Why It Matters</h2>
            <p><strong>BeautyPreneur isn't just a tech product.</strong> It's a tool for economic independence and dignity. Through inclusive UX and thoughtful problem-solving, we open doors for women to learn, grow, and thrive on their own terms.</p>
          </section>
        </div>
      )
    },
      ...
      content: (
        <div className={styles.caseStudyContent}>
          <section className={styles.section}>
            <h2>1. Understanding the Problem</h2>
            <p className={styles.caption}>
              <a href="https://www.figma.com/board/oIsRuCA2kL2aZBhOT3mipN/UX-Research-K%E2%80%99Parkir--TEAM-4FA-?node-id=1-4&t=MV77AxodCAXIEZbx-1" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See Detail Here : UX Research</a>
            </p>
          ...
          <section className={styles.section}>
            <h2>2. My Role in the Project</h2>
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/reqtify-team.JPG")} alt="Team 4FA structure and collaboration process" className={styles.contentImage} />
            </div>
          ...
          <section className={styles.section}>
            <h2>4. Why Other Ideas Didn't Work</h2>
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/Compotitor Analisis K'PARKIR.png")} alt="Competitive analysis of PARKEE, JakParkir, and Jukir showing feature gaps" className={styles.contentImage} />
          ...
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("portfolio/K'parkir.png")} alt="K'Parkir solution features: Live Park View and ParkShare" className={styles.contentImage} />
              <p className={styles.caption}>
                <a href="https://www.figma.com/design/tgp09Q84VoR5j3PSiz56OG/UI-Design-K%E2%80%99Parkir--TEAM-4FA-?node-id=0-1&t=zEZyTWMxDNMeYGVH-1" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See Detail here : UI Design & Prototype</a>
              </p>
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/Business Model Canvas (BMC) K'PARKIR.png")} alt="Business Model Canvas showing revenue streams and success metrics" className={styles.contentImage} />
      ...
      content: (
        <div className={styles.caseStudyContent}>
          <section className={styles.section}>
            <h2>1. Understanding the Problem</h2>
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/sibi-problem.jpg")} alt="Maternal mental health statistics in Indonesia" className={styles.contentImage} />
              <p className={styles.caption}>
                <a href="https://www.figma.com/design/xQs3X179UkOsKJBj0axGhP/Basic-Course---4.2-Landing-Page-Design-Challenge--Sabrina-Natasya-Bilbina-?node-id=2009-1322&t=vlfQ4snJZrtWmZee-1" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See detail here → Project Brief</a>
              </p>
            </div>
          ...
          <section className={styles.conclusion}>
            <h2>💬 Why It Matters</h2>
            <p><strong>SIBI isn't just another health app.</strong> It's a lifeline for mothers who feel alone in their struggle. By combining human-centered design with deep cultural understanding, we create a safe space where Indonesian mothers can find support, reduce stigma, and build healthier families starting with their own mental wellbeing.</p>
          </section>
        </div>
      )
    },
      ...
      content: (
        <div className={styles.caseStudyContent}>
          <section className={styles.section}>
            ...
            <div className={styles.imageWithCaption}>
              <img src={getImageUrl("casestudy/hermoney-problem.jpg")} alt="Financial inequality statistics showing women's challenges in financial literacy" className={styles.contentImage} />
              <p className={styles.caption}>
                <a href="https://www.canva.com/design/DAGS66yHX1k/y8DTfRJjnUDphUqYJdpKtg/edit" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See detail here → Research Presentation</a>
              </p>
            </div>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.caption}>
              <a href="https://hermoney.netlify.app/" target="_blank" rel="noopener noreferrer" className={styles.detailLink}>See detail → Live Website</a>
            </p>
            <h3>🛠️ Current Limitations:</h3>
            <ul>
          ...
          <section className={styles.conclusion}>
            ...
            <p><strong>HerMoney is more than just a financial education platform</strong> — it's a tool for economic liberation. By addressing the root causes of financial inequality through human centered design, we can empower women to break free from dependency cycles, build confidence in managing their finances, and create a more equitable future where every woman has the knowledge and tools to achieve financial independence.</p>
          </section>
        </div>
      )
    }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.scrollButtons}>
        <button
          className={`${styles.scrollBtn} ${showScrollDown ? styles.scrollBtnVisible : ""}`}
