...
export const Portfolio = ({ showAll = false }) => {
  ...
  const portfolio = [
    ...
    },
    {
      ...
      description:
        "A smart parking app designed to reduce time spent searching for parking in Jakarta. K'Parkir integrates real-time availability, navigation, to improve urban mobility and reduce illegal parking.",
      ...
      source:
        "https://www.canva.com/design/DAG2sQv1ZgY/mg5SR5hQ9SBsEZ4eeCfjfg/edit?utm_content=DAG2sQv1ZgY&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton",
      type: "case-study",
      role: "uiux",
    },
    {
      ...
      description:
        "Redesigning Spotify Experience : Spotify ReqTify - Optimizing Content Availability on Spotify. This project was executed as part of the Startup Campus UI/UX Design 2025 program.",
      demo: "https://www.figma.com/board/QMwPmcta4QEIcOhLQMol7V/Spotify-Research---Team-1?node-id=0-1&t=9l5QqLpsoWVQurpV-1",
      source:
        "https://www.figma.com/design/CKFhVcvDKB5PxwtMAn3Aea/Team-1---Prototype?node-id=0-1&t=k9KKeZfPhl5oNao3-1",
      type: "case-study",
      role: "uiux",
    },
    {
      ...
      description:
        "An analytical presentation exploring the fundamental differences between User Interface and User Experience through real-world product observations, scoring 91/100.",
    ...
    },
    {
      ...
      description:
        "A platform that provides makeup training and beauty sessions to help women gain skills and access job opportunities. Includes a budgeting tool to find the right price for makeup needs.",
    ...
    },
    {
      ...
      description:
        "A mental health companion for Indonesian mothers during pregnancy and postpartum. Features anonymous chat, bonding classes, and access to local resources.",
    ...
    },
    {
      ...
      description:
        "A financial education platform designed for women to learn inclusively and affordably. Focused on accessibility, empowerment, and breaking financial barriers.",
    ...
    },
    {
      ...
      description:
        "A lightweight tool to calculate Body Mass Index (BMI) instantly. It provides clear results with categorized health ranges, for users to understand their wellness levels.",
    ...
    },
    {
      ...
      description:
        "A web app for accurate geometry calculations. It helps students practice formulas efficiently while improving their understanding of basic math concepts.",
      demo: "https://revou-fundamental-course.github.io/25-dec-23-sabrintsya.github.io/",
      source:
        "https://github.com/revou-fundamental-course/25-dec-23-sabrintsya.github.io",
      type: "github",
      role: "frontend developer",
    },
    {
      ...
      description:
        "A furniture landing page that showcases modern and functional designs. Space-saving pieces for daily living, while emphasizing comfort.",
    ...
    },
    {
      ...
      description:
        "A responsive landing page for a digital news platform. Designed to provide quick access to the latest headlines and categorized information.",
    ...
    },
    {
      ...
      description:
        "A web app to manage personal reading lists efficiently. Users can add, track, and organize books they have read or plan to read.",
  ...
  const filteredPortfolio =
    activeFilter === "all"
      ? portfolio
      : portfolio.filter((item) => item.role.includes(activeFilter));

  const featured = filteredPortfolio.slice(0, 3);
  const displayed = showAll ? filteredPortfolio : featured;
